const Hero = () => {
  return (
    <section id="home" className="w-full h-screen flex flex-col justify-center items-center min-h-screen pt-[10rem] bg-cover bg-center">
      ...
      <a href="https://pump.fun/"><button className="animate-pulse mt-6 bg-[#f6e62f] text-[#000] px-28 py-6 hover:bg-[#33360f] border-4 border-black font-black  font-elite  text-[24px] ">
        BUY $JEETIO
      </button></a>
