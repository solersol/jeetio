const Hero = () => {
  return (
    <section id="home" className="w-full h-screen flex flex-col justify-center items-center min-h-screen pt-[10rem] bg-cover bg-center">
      ...
      <a href="https://pump.fun/"><button className="animate-pulse mt-6 bg-[#81061d] text-[#000] px-28 py-6 hover:bg-[#36160f] border-4 border-black font-black  font-elite  text-[24px] ">
        BUY $AVTU
      </button></a>
